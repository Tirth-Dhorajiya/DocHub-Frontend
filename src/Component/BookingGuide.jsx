					...
					<Card className='shadow-sm'>
						...
						<Card.Body className='text-center'>
							...
							<Card.Text>
								...
								member. <br />- Securely manage your appointments and profile.{' '}
							</Card.Text>{' '}
							<Link to='/signIn'>
								{' '}
				...
				<Col md={5}>
					...
					<Card className='booking-step-card shadow-sm'>
						...
						<Card.Body className='text-center'>
							...
							<Card.Text>
								{' '}
								- Browse through our list of experienced doctors. <br />- Select
								your preferred time and date for the appointment.{' '}
							</Card.Text>{' '}
